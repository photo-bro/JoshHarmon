...
namespace JoshHarmon.Github {
    public class CachedGithubService : IGithubService, ICached {
        ...
        private async Task<IEnumerable<Commit>> GetRepositoryCommitsAsyncImpl (string repositoryName) => await _client
            .Repository
            .Commit
        ...
        public async Task<RepoStats> GetRepositoryStatsAsync (string repositoryName) => await _cacheProvider.TryGetFromCacheAsync (
        ...
        public async Task<IEnumerable<RepoContributor>> GetRepositoryContributorsAsync (string repositoryName) => await _cacheProvider.TryGetEnumerableFromCacheAsync (
